-- Bookstore Management System Sample Data Seeding
-- For PostgreSQL database initialization.
-- Seed Admin user, Categories, Authors, Publishers, Books, and Transactional Data.

-- 1. Insert disabled placeholder admin audit user.
...
-- 2. Insert category, author, publisher, and book data
DO $$
DECLARE
    admin_user_id UUID;
BEGIN
    ...
    IF admin_user_id IS NULL THEN
        RAISE EXCEPTION 'Admin user not found. Please ensure users seed has run.';
    END IF;
